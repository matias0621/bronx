...
export default function Service({ Title, Description, Photo }: ServiceProps) {
  return (
    <section
      className="-z-10 flex flex-col items-center py-4 mx-auto bg-greyDesing w-4/5 rounded-xl my-4 sm:w-[90%] sm:h-60 sm:p-0 sm:flex-row"
    >
      ...
      <div className="flex items-center flex-col gap-y-4 sm:text-center sm:items-between sm:w-1/2 sm:gap-y-0 sm:h-4/5">
        ...
        <p className="w-4/5 sm:w-3/4 lg:text-[0.9rem]">{Description}</p>
        
        <div className="sm:h-10 h-10  flex items-center justify-center w-full mt-2">
          <button
